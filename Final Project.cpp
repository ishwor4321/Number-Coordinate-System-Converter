...
class graphics{
	...
	public:
		void main(){
	initwindow(2000,1000,"Converter");	
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,6);
	setcolor(CYAN);
	for(int i=0;i<565;i++){
	int p=i+i;
	rectangle(400,800-p,1400,950-p);
	delay(1);
	outtextxy(440,850-p,"Welcome to our C++ project");	
	outtextxy(500,1000-p,"Pulchowk Campus");
	outtextxy(500,1100-p,"C++ Project");
	outtextxy(500,1200-p,"Special Thanks to");
	outtextxy(500,1300-p,"Bibha Sthapit Mam");
	outtextxy(500,1400-p,"And");
	outtextxy(500,1500-p,"Bikal Adhikari Sir");
	outtextxy(500,1600-p,"Batch:BEL076");
	outtextxy(500,1700-p,"Submitted to:");
	outtextxy(500,1800-p,"Department of ECE");
	delay(1);		
	}
	for(int j=0;j<370;j++)
	{
	int k=j+j;
	line(500+k,740,500+k,1009);
	delay(10);
    }    
	cleardevice();
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,5);
	outtextxy(600,150," CONVERTER ");
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,4);	
	outtextxy(20,215,"Prepared By : ");	
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,3);
	setfillstyle(SOLID_FILL,CYAN);
	circle(25,312,7);
	floodfill(25,312,CYAN);
	outtextxy(40,300,"Amrit Thapa (076EL006)");	
	circle(25,412,7);
	floodfill(25,412,CYAN);	
	outtextxy(40,400,"Adarsha Chalise (076BEL003)");
	circle(25,512,7);
	floodfill(25,512,CYAN);	
	outtextxy(40,500,"Brijkishore Pandit (076BEL015)");
	circle(25,612,7);
	floodfill(25,612,CYAN);	
	outtextxy(40,600,"Ishwor Shrestha (076BEL018)");	
	outtextxy(40,700,"Press any key to continue");
	getch();
	cleardevice();
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,6);
	outtextxy(565,150,"Welcome to Converter");
	settextstyle(EUROPEAN_FONT,HORIZ_DIR,4);
	outtextxy(40,300,"Here you can convert:");
	setfillstyle(SOLID_FILL,CYAN);
	circle(35,362,7);
	floodfill(35,362,CYAN);
	outtextxy(50,350,"Number System");
	circle(35,412,7);
	floodfill(35,412,CYAN);
	outtextxy(50,400,"Coordinate System");
	getch();
	cleardevice();
    outtextxy(40,300,"Enter your choice:");
	outtextxy(40,350,"Enter 1 for Number System Converter.");
	outtextxy(40,400,"Enter 2 for coordinate System Converter.");
	outtextxy(40,500,"Enter any key.....You will be forwarded to exe files..");
	getch();		
	closegraph();
}
	};
